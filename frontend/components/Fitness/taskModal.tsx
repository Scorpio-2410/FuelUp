// frontend/components/Fitness/taskModal.tsx
...
interface TaskModalProps {
  ...
  setCategory: (c: "meal" | "workout" | "other") => void;
}
      ...
      <View
        ...
        <View
          ...
          <View style={{ flexDirection: "row", gap: 8, marginBottom: 12 }}>
            {(["workout", "meal", "other"] as const).map((c) => (
              <TouchableOpacity
                key={c}
                ...
                style={{
                  ...
                  borderWidth: 1,
                  borderColor: "#ccc",
                  backgroundColor: category === c ? "#B3FF6E" : "white",
                  marginRight: 8,
                }}>
                <Text style={{ color: "green", fontWeight: "600" }}>{c}</Text>
              </TouchableOpacity>
            ))}
          </View>
